...
const navigation = [
  ...
  { name: "Messaggi", href: "#", icon: MessageOutlinedIcon, current: false },
];

const project = [
  { name: "Progetti", href: "#", icon: FolderCopyOutlinedIcon, current: false },
];

const amministrazione = [
  { name: "Dipendenti", href: "#", icon: BadgeOutlinedIcon, current: false },
  { name: "Clienti", href: "#", icon: PeopleAltOutlinedIcon, current: false },
  {
    name: "Preventivi",
    href: "#",
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <div className="relative flex flex-1" action="#" method="GET">
                ...
                <input className="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" />
              </div>
